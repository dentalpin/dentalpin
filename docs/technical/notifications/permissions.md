...
| `notifications.push.write` | Register/remove a patient's browser push subscription. | `POST /api/v1/notifications/push/subscriptions`, `DELETE /api/v1/notifications/push/subscriptions/{id}` |
