        ...
        <div class="p-4 space-y-3">
          ...
          <div class="flex gap-3">
            ...
            <UFormField :label="t('medications.fields.unit')" class="flex-1">
              <USelect v-model="draft.unit" :items="unitSelectItems" value-key="value" label-key="label" class="w-full" />
            </UFormField>
          </div>

          <UFormField :label="t('medications.fields.form')">
            <USelect v-model="draft.form" :items="formSelectItems" value-key="value" label-key="label" class="w-full" />
          </UFormField>
