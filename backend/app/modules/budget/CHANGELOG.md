...
- feat(#485): quote PDF labels for every UI locale (fr/pt/de/hu/pl/it/ar/ta, lifted from the host `budget.*` strings); Arabic renders `dir="rtl"` with logical table alignment.
